...
struct Server {
    command_sender: Sender<(u32, generated::PlayerCommand)>,
    ip_to_player_id: Arc<Mutex<HashMap<SocketAddr, u32>>>,
    socket: UdpSocket,
}

impl Server {
    fn new() -> io::Result<(Server, Receiver<(u32, generated::PlayerCommand)>)> {
    ...
    fn handle_packet(&self, packet: &[u8], src_addr: SocketAddr) {
        let player_commands =
            root::<generated::PlayerCommands>(packet).expect("No command received");
    ...
    fn start_tick_thread(
        self: Arc<Self>,
        command_receiver: Receiver<(u32, generated::PlayerCommand)>,
    ) {
    ...
    fn tick(
        ...
        commands: &[(u32, generated::PlayerCommand)],
        dt: f32,
    ) {
